...
/**
 * Created by Gaurav Makkar on 29/10/16.
 */
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {

    private static final String DONATION_1 = "gauravmakkar.songbong.donate_1";
    private static final String DONATION_2 = "gauravmakkar.songbong.donate_2";
    private static final String DONATION_3 = "gauravmakkar.songbong.donate_3";
    private static final String DONATION_5 = "gauravmakkar.songbong.donate_5";
    private static final String DONATION_10 = "gauravmakkar.songbong.donate_10";
    private static final String DONATION_20 = "gauravmakkar.songbong.donate_20";
