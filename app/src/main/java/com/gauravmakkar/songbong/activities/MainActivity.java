...
import com.gauravmakkar.songbong.MusicPlayer;
import com.gauravmakkar.songbong.R;
import com.gauravmakkar.songbong.fragments.AlbumDetailFragment;
import com.gauravmakkar.songbong.fragments.ArtistDetailFragment;
import com.gauravmakkar.songbong.fragments.FoldersFragment;
import com.gauravmakkar.songbong.fragments.MainFragment;
import com.gauravmakkar.songbong.fragments.PlaylistFragment;
import com.gauravmakkar.songbong.fragments.QueueFragment;
import com.gauravmakkar.songbong.permissions.Nammu;
import com.gauravmakkar.songbong.permissions.PermissionCallback;
import com.gauravmakkar.songbong.slidinguppanel.SlidingUpPanelLayout;
import com.gauravmakkar.songbong.utils.Constants;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    Runnable loginView = new Runnable() {
        public void run() {
            navigateLibrary.run();
    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Nammu.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, "Song Bong will need to read external storage to display songs on your device.",
    ...
    private void setupNavigationIcons(NavigationView navigationView) {
        ...
        if (!isDarkTheme) {
            ...
            navigationView.getMenu().findItem(R.id.login_form).setIcon(R.drawable.payment_black);
        } else {
            ...
            navigationView.getMenu().findItem(R.id.login_form).setIcon(R.drawable.payment_white);
        }
