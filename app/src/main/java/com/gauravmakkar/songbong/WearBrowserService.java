...
import com.gauravmakkar.songbong.dataloaders.AlbumLoader;
import com.gauravmakkar.songbong.dataloaders.AlbumSongLoader;
import com.gauravmakkar.songbong.dataloaders.ArtistAlbumLoader;
import com.gauravmakkar.songbong.dataloaders.ArtistLoader;
import com.gauravmakkar.songbong.dataloaders.ArtistSongLoader;
import com.gauravmakkar.songbong.dataloaders.PlaylistLoader;
import com.gauravmakkar.songbong.dataloaders.PlaylistSongLoader;
import com.gauravmakkar.songbong.dataloaders.SongLoader;
import com.gauravmakkar.songbong.models.Album;
import com.gauravmakkar.songbong.models.Artist;
import com.gauravmakkar.songbong.models.Playlist;
import com.gauravmakkar.songbong.models.Song;
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "gauravmakkar.songbong/drawable/ic_empty_music2"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "gauravmakkar.songbong/drawable/ic_empty_music2"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "gauravmakkar.songbong/drawable/ic_empty_music2"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "gauravmakkar.songbong/drawable/ic_empty_music2"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
